...
// Row 2: AI/ML, Databases, Cloud & DevOps
const technologiesRow2 = [
  ...
  {
    name: 'LangFuse',
    icon: 'https://avatars.githubusercontent.com/u/121682336',
...
<template>
  <section class="border-b border-default overflow-hidden">
    <div class="py-12">
      <!-- Section Header -->
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
        <p class="font-mono text-sm text-primary uppercase tracking-widest mb-2">Technologies</p>
        <h2 class="font-mono text-2xl sm:text-3xl font-bold tracking-tight">Our Tech Stack</h2>
      </div>
      ...
      <div class="relative">
        <!-- Gradient Fade Left -->
        <div
          class="absolute left-0 top-0 bottom-0 w-24 bg-gradient-to-r from-default to-transparent z-10 pointer-events-none"
        />

        <!-- Gradient Fade Right -->
        <div
          class="absolute right-0 top-0 bottom-0 w-24 bg-gradient-to-l from-default to-transparent z-10 pointer-events-none"
        />

        <!-- Row 1: Frontend, Backend & Languages - Left to Right -->
        <div class="marquee-container mb-4">
          <div class="marquee-track animate-scroll-left">
            <a
              v-for="tech in technologiesRow1"
              :key="tech.name"
              :href="tech.url"
              target="_blank"
            ...
            >
              <div
                class="size-16 sm:size-20 border border-default bg-default p-3 sm:p-4 hover:border-foreground transition-colors"
              >
                <img
                  :src="tech.icon"
                  :alt="tech.name"
        ...
        <!-- Row 2: AI/ML, Databases, Cloud & DevOps - Right to Left -->
        <div class="marquee-container">
          <div class="marquee-track animate-scroll-right">
            <a
              v-for="tech in technologiesRow2"
              :key="tech.name"
              :href="tech.url"
              target="_blank"
              rel="noopener noreferrer"
